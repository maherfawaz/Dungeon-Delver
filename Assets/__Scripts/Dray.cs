...
public class Dray : MonoBehaviour, IFacingMover, IKeyMaster {
    ...
    public KeyCode keyAttackAlt = KeyCode.Space;
    public KeyCode keyGadget = KeyCode.X;
    public KeyCode keyGadgetAlt = KeyCode.E;
    [SerializeField]
    ...
    void Update() {
        ...
        if (mode == eMode.idle || mode == eMode.move) {
            ...
            if (Input.GetKeyDown(keyGadget) || Input.GetKeyDown(keyGadgetAlt)) { 
            ...
            if (Input.GetKeyDown(keyAttack) || Input.GetKeyDown(keyAttackAlt) && Time.time >= timeAtkNext) {
                mode = eMode.attack;
